...
function Avatar() {
  ...
  return (
    <div
      ...
      style={{
        background:
          'linear-gradient(135deg, hsl(var(--primary)), hsl(199 92% 73%))',
      }}
...
export function Hero() {
  ...
  // Display the German number first on the hero; other surfaces keep config order.
  const phones = [...config.extraPhones, config.phone].filter(
    ...
    >
      ...
      >
        ...
        >
          ...
          {(config.location || phones.length > 0) && (
